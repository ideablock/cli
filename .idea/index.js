...
function parentIdeas (callback) {
  fetch('https://beta.ideablock.io/cli/get-parent-ideas', { method: 'post', body: { 'api_token': jsonAuthContents.auth } })
    .then(res => {
      parentArray = [res.json]
      parentObject = res.json
      callback(null, parentArray)
    })
}
